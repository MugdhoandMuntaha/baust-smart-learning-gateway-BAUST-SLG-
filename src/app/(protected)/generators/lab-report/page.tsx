        ...
        <aside style={{ flexGrow: 1, minWidth: '300px', maxWidth: '400px', position: 'sticky', top: '2rem' }}>
          <div style={{ background: '#fff', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)', display: 'flex', flexDirection: 'column', maxHeight: 'calc(100vh - 4rem)' }}>
            ...
            <div style={{ padding: '1.5rem 1.5rem 1rem 1.5rem', borderBottom: '1px solid #f3f4f6' }}>
              <h3 style={{ fontSize: '1.2rem', fontWeight: 600, color: '#1f2937', margin: 0 }}>Report Settings</h3>
            </div>
            ...
            <div style={{ padding: '1.5rem', overflowY: 'auto', flex: 1 }}>
              ...
              <div>
                ...
                <input type="text" value={form.courseNo} onChange={e => setForm({...form, courseNo: e.target.value})} style={{ width: '100%', padding: '0.5rem', border: '1px solid #d1d5db', borderRadius: '6px', fontSize: '0.875rem' }} placeholder="e.g. CSE 2202" />
              </div>
              <div style={{ display: 'flex', gap: '1rem' }}>
                <div style={{ flex: 1 }}>
                  <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, marginBottom: '0.25rem', color: '#374151' }}>Experiment No</label>
                  <input type="text" value={form.experimentNo} onChange={e => setForm({...form, experimentNo: e.target.value})} style={{ width: '100%', padding: '0.5rem', border: '1px solid #d1d5db', borderRadius: '6px', fontSize: '0.875rem' }} placeholder="e.g. 01" />
                </div>
                <div style={{ flex: 1 }}>
                  <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, marginBottom: '0.25rem', color: '#374151' }}>Date</label>
                  <input type="date" value={form.experimentDate} onChange={e => setForm({...form, experimentDate: e.target.value})} style={{ width: '100%', padding: '0.5rem', border: '1px solid #d1d5db', borderRadius: '6px', fontSize: '0.875rem', color: '#374151' }} />
                </div>
              </div>
              <div>
                <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, marginBottom: '0.25rem', color: '#374151' }}>Experiment Name</label>
                <input type="text" value={form.experimentName} onChange={e => setForm({...form, experimentName: e.target.value})} style={{ width: '100%', padding: '0.5rem', border: '1px solid #d1d5db', borderRadius: '6px', fontSize: '0.875rem' }} placeholder="e.g. Implementation of Stack" />
              </div>
              <div>
